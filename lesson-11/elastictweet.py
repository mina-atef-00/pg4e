...
docs = (
    ...
    },
    {
        "author": "asdfdsa",
        "type": "tweet",
        "text": "Taking a break helps with the thinking So does talking If you explain",
        "timestamp": datetime.now(),
    },
    {
        "author": "tutyi",
        "type": "tweet",
        "text": "the problem to someone else or even to yourself you will sometimes",
        "timestamp": datetime.now(),
    },
    {
        "author": "rrrrrr",
        "type": "tweet",
        "text": "find the answer before you finish asking the question",
        "timestamp": datetime.now(),
    },
    {
        "author": "kkkkk",
        "type": "tweet",
        "text": "But even the best debugging techniques will fail if there are too many",
        "timestamp": datetime.now(),
    },
    {
        "author": "bbbb",
        "type": "tweet",
        "text": "errors or if the code you are trying to fix is too big and complicated",
        "timestamp": datetime.now(),
    },
)
